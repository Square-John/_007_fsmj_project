...
class FeishuDownloader:
    ...
    def get_minutes_url(self, minutes):
        ...
        # 写入字幕文件
        with open(f'{save_path}/{subtitle_name}.{self.subtitle_type}', 'w', encoding='utf-8') as f:
            f.write(resp.text)
